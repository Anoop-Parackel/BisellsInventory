<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Brands.aspx.cs" Inherits="BisellsERP.Masters.Brands" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="childContent" runat="server">
 ...
 <%--hidden fields--%>
        ...
        <asp:HiddenField ID="hdBrandId" ClientIDMode="Static" runat="server" Value="0" />
        <%--Page Title and Breadcrumb--%>
        <div class="row">
            <div class="col-sm-12">
                <h3 class="pull-left page-title">Brands</h3>
                ...
                <div class="portlet b-r-8">
                    <div class="portlet-heading portlet-default">
                        <h3 class="portlet-title">
                            <a id="btnAdd" data-toggle="collapse" data-parent="#accordion1" href="#add-item-portlet" class="text-primary"><i class="ion-ios7-plus-outline"></i>&nbsp;Add New Brand</a>
                        </h3>
                        ...
                        <div class="portlet-body b-r-8">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Order:</label>
                                        <asp:TextBox data-validation="required" onkeypress="return this.value.length<=20" TextMode="Number" data-validation-error-msg="<small style='color:red'>This field is required</small>" ID="txtOrder" ClientIDMode="Static" runat="server" class="form-control " placeholder="Order"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Tax.aspx.cs" Inherits="BisellsERP.Masters.Tax" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="childContent" runat="server">
        ...
        <asp:HiddenField ID="hdTaxId" ClientIDMode="Static" runat="server" Value="0" />
        <%--Page Title and Breadcrumb--%>
        <div class="row">
            <div class="col-sm-12"> 
                <h3 class="pull-left page-title">Tax Master</h3>
                ...
                <div class="portlet b-r-8">
                    <div class="portlet-heading portlet-default">
                        <h3 class="portlet-title">
                            <a id="btnAdd" data-toggle="collapse" data-parent="#accordion1" href="#add-item-portlet" class="text-primary"><i class="ion-ios7-plus-outline"></i>&nbsp Add New Tax </a>
                        </h3>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrapper ">
                                            <asp:TextBox data-validation="required" MaxLength="30" data-validation-error-msg="<small style='color:red'>This field is required</small>" ID="txtTaxName" ClientIDMode="Static" runat="server" class="form-control " placeholder="Tax Name"></asp:TextBox>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrapper ">
                                            <asp:TextBox data-validation="required" Text="0.00" onkeypress="return this.value.length<=15"  data-validation-error-msg="<small style='color:red'>This field is required</small>" ID="txtTaxPercentage" ClientIDMode="Static" runat="server" class="form-control " placeholder="Tax Percentage"></asp:TextBox>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrapper ">
                                            <asp:TextBox data-validation="required" MaxLength="20" data-validation-error-msg="<small style='color:red'>This field is required</small>" ID="txtTaxType" ClientIDMode="Static" runat="server" class="form-control " placeholder="Tax Type"></asp:TextBox>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrapper ">
                                            <asp:DropDownList ClientIDMode="Static" CssClass="form-control" ID="ddlTaxStatus" runat="server">

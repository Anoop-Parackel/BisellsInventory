<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vehicles.aspx.cs" Inherits="BisellsERP.Masters.Vehicles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="childContent" runat="server">
    ...
    <asp:HiddenField ID="hdVehicleId" ClientIDMode="Static" runat="server" Value="0" />

    <%--Page Title and Breadcrumb--%>
    <div class="row">
        <div class="col-sm-12">
            <h3 class="pull-left page-title">Vehicle Master</h3>
            ...
            <div class="portlet b-r-8">
                <div class="portlet-heading portlet-default">
                    <h3 class="portlet-title">
                        <a id="btnAdd" data-toggle="collapse" data-parent="#accordion1" href="#add-item-portlet" class="text-primary"><i class="ion-ios7-plus-outline"></i>&nbsp Add New Vehicle </a>
                    </h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group" >   
                                        ...
                                        <div class="form-control-wrapper ">
                                            <asp:TextBox ID="txtNumber" MaxLength="20"  ClientIDMode="Static" runat="server" class="form-control " placeholder="Number"></asp:TextBox>
                                            <asp:RegularExpressionValidator EnableClientScript="true" ID="RegularExpressionValidator1"  ControlToValidate="txtNumber" runat="server" ErrorMessage="Enter proper data" ValidationExpression="^[a-zA-Z0-9_@.-]*$"></asp:RegularExpressionValidator>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group" >
                                        ...
                                        <div class="form-control-wrapper ">
                                              <asp:TextBox ID="txtType" MaxLength="20"  ClientIDMode="Static" runat="server" class="form-control " placeholder="Type"></asp:TextBox>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group" >
                                        ...
                                        <div class="form-control-wrapper ">
                                            <asp:TextBox data-validation="required" MaxLength="20" data-validation-error-msg="<small style='color:red'>This field is required</small>" ID="txtOwner" ClientIDMode="Static" runat="server" class="form-control " placeholder="Owner"></asp:TextBox>
                                            <i class="font-icon font-icon-burger"></i>
                                        </div>
                                    </div>
                                </div>
            ...
            $(document).on('click', '.edit-entry', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#txtType').val(response.Type);
                        $('#txtOwner').val(response.Owner);
                        $('#ddlStatus').val(response.Status);
                        $('#hdVehicleId').val(response.ID);

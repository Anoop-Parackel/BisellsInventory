<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="BisellsERP.Masters.Category" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="childContent" runat="server">
    ...
    <div class="row">
        <div class="col-sm-12">
            <h3 class="pull-left page-title">Category Master</h3>
                ...
                <div class="portlet b-r-8">
                    <div class="portlet-heading portlet-default">
                        <h3 class="portlet-title">
                            <a id="btnAdd" data-toggle="collapse" data-parent="#accordion1" href="#add-item-portlet" class="text-primary"><i class="ion-ios7-plus-outline"></i>&nbsp;Add New Category </a>
                        </h3>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group" style="padding-left: 10px; padding-right: 10px">
                                        ...
                                        <div class="form-control-wrapper form-control-icon-left">
                                            <asp:TextBox ID="txtCategoryName" MaxLength="20" ClientIDMode="Static" runat="server" class="form-control " placeholder="Name"></asp:TextBox>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group" style="padding-left: 10px; padding-right: 10px">
                                        ...
                                        <div class="form-control-wrapper form-control-icon-left">
                                            <asp:TextBox data-validation="required" onkeypress="return this.value.length<=15" TextMode="Number" data-validation-error-msg="<small style='color:red'>This field is required</small>" ID="txtCategoryOrder" ClientIDMode="Static" runat="server" class="form-control " placeholder="Order"></asp:TextBox>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group" style="padding-left: 10px; padding-right: 10px">
                                        ...
                                        <div class="form-control-wrapper form-control-icon-left">
                                            <asp:DropDownList ClientIDMode="Static" CssClass="form-control" ID="ddlCategoryStatus" runat="server">

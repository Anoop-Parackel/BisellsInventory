...
{
    public partial class RegisterIn : System.Web.UI.Page
    {
        ...
        {
            lblOrderNo.Text = Entities.Register.Register.GetOrderNo(Publics.CPublic.GetCompanyID(), Publics.CPublic.GetFinYear(), "RIN");

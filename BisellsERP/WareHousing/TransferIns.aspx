<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TransferIns.aspx.cs" Inherits="BisellsERP.WareHousing.TransferIns" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="childContent" runat="server">
    ...
    <div class="row p-b-10">
        <div class="col-sm-4">
            <h3 class="page-title m-t-0">Transfer Ins</h3>
        </div>
        <div class="col-sm-8">
                ...
                <div class="list-group-item active m-b-10">
                    <div class="btn-group">
                        <button type="button" class="trans-btn dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            All Transfer Ins&nbsp;<b id="countOfInvoices">(0)</b>&nbsp;<span class="caret"></span>
                        </button>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="empty-state-wrap" style="display: none">
                                    ...
                                    <div class="btn-group empty-state-buttons">
                                        <a href="/Warehousing/TransferIn?MODE=new" class="btn btn-default btn-xs btn-rounded waves-effect">Create New Transfer In</a>
                                    </div>
                                </div>
                        </div>
                    </div>
                                ...
                                <div class="">
                                    ...
                                    <div class="row" style="margin-top: 15px;">
                                        ...
                                        <input id="hdEmail" type="hidden" value="0" />
                                            ...
                                            <address>
                                                <b>
                                                    <small class="text-muted">Details of location: </small><small id="lblLocName" class="underline"></small>
                                                </b>
                                                <br />
...
<%--    <script type="text/javascript" src="//cdn.jsdelivr.net/momentjs/latest/moment.min.js"></script>
    ...
    <script>
        ...
        $(document).ready(function () {
            $.ajax({
                url: $('#hdApiUrl').val() + 'api/TransferIn/GetCompanyDetails/',
                method: 'POST',
            ...
            function refreshTable(locationId, fromDate, toDate) {
                ...
                $.ajax({
                    url: $('#hdApiUrl').val() + 'api/TransferIn/Get?locationId=' + locationId + '&from=' + fromDate + '&to=' + toDate,
                    method: 'POST',
                    contentType: 'application/json;charset=utf-8',
                    dataType: 'JSON',
                    data: JSON.stringify($.cookie('bsl_2')),
            ...
            $(document).on('click', '.edit-register', function () {
                window.open('/WareHousing/TransferIn?MODE=edit&UID=' + $('#hdRegisterId').val(), '_self');
            });
            ...
            $(document).on('click', '.print-register', function () {
                ...
                PopupCenter('/WareHousing/print/' + type + '/' + number + '/TransferIn?id=' + $('#hdRegisterId').val() + "&location=" + $.cookie('bsl_2'), 'TransferIn', 1000, 1000);
            });
            $(document).on('click', '.clone-register', function () {
                window.open('/wareHousing/TransferIn?MODE=clone&UID=' + $('#hdRegisterId').val(), '_self');
            });
            $(document).on('click', '.new-register', function () {
                window.open('/Warehousing/TransferIn?MODE=new', '_self');
            });

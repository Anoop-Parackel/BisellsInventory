...
namespace BisellsERP.WareHousing
{
    public partial class TransferIn : System.Web.UI.Page
    {
        ...
        protected void Page_LoadComplete(object sender, EventArgs e)
        {
            ...
            hdTandC.Value = Entities.Application.Settings.GetSetting(146);
            ddlJob.LoadJobs(Publics.CPublic.GetCompanyID());
            lblOrderNo.Text = Entities.Register.Register.GetOrderNo(Publics.CPublic.GetCompanyID(), Publics.CPublic.GetFinYear(), "TIN");

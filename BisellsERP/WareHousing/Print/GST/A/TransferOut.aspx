<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferOut.aspx.cs" Inherits="BisellsERP.WareHousing.Print.GST.A.TransferOut" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
  <title>TransferOut Print</title>
    <%-- STYLE SHEETS --%>
                ...
                <div class="col-md-12">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-xs-5 text-center">
                            <h2 class="text-primary m-t-0 m-b-30"><strong>Transfer Out</strong></h2>

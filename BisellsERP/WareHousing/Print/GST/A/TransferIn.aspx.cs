        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["id"] != null && Request.QueryString["location"] != null)
                {
                    ...
                    lblLocRegId.Text = ti.LocationRegId;
                    lblComp.Text = c.Name;
                    ...
                    lblTotal.Text = Convert.ToString(ti.Gross);
                    ...
                    tAndC.Text = Convert.ToString(ti.TermsAndConditions);
                    for (int i = 0; i < ti.Products.Count; i++)
                    {
                        ...
                        t4.Text = ti.Products[i].MRP.ToString();
                        r.Cells.Add(t4);
                        TableCell t5 = new TableCell();
                        t5.Text = ti.Products[i].CostPrice.ToString();
                        r.Cells.Add(t5);
                        TableCell t6 = new TableCell();
                        t6.Text = ti.Products[i].Quantity.ToString();
                        r.Cells.Add(t6);
                        ...
                        t9.Text = (Convert.ToDecimal(ti.Products[i].TaxAmount) / 2).ToString();
                        r.Cells.Add(t9);
                        TableCell t10 = new TableCell();
                        t10.Text = (Convert.ToDecimal(ti.Products[i].TaxAmount) / 2).ToString();
                        r.Cells.Add(t10);
                        TableCell t11 = new TableCell();
                        t11.Text = "0.00";
                        r.Cells.Add(t11);
                        TableCell t12 = new TableCell();
                        t12.Text = ti.Products[i].NetAmount.ToString();
                        r.Cells.Add(t12);

...
namespace BisellsERP.WareHousing.Print.VAT.A
{
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["id"] != null && Request.QueryString["location"] != null)
                {
                    ...
                    lblGross.Text = Convert.ToString(to.Gross);
                    ...
                    for (int i = 0; i < to.Products.Count; i++)
                    {
                        ...
                        t4.Text = to.Products[i].Quantity.ToString();
                        r.Cells.Add(t4);
                        TableCell t5 = new TableCell();
                        t5.Text = to.Products[i].MRP.ToString();
                        r.Cells.Add(t5);
                        TableCell t6 = new TableCell();
                        t6.Text = to.Products[i].CostPrice.ToString();
                        r.Cells.Add(t6);
                        ...
                        t9.Text = to.Products[i].TaxAmount.ToString();
                        r.Cells.Add(t9);
                        TableCell t10 = new TableCell();
                        t10.Text = to.Products[i].NetAmount.ToString();
                        r.Cells.Add(t10);

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Quote.aspx.cs" Inherits="BisellsERP.Purchase.Print.VAT.D.Quote" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-xs-6 text-right">
                            <h2 class="text-greeen m-t-40">
                                <strong>
                                    <asp:Label ID="lblMainHead" runat="server" CssClass="underline text-green">PURCHASE ORDER</asp:Label></strong>
                            </h2>
                            <br />
                        </div>
                        ...
                        <div class="col-xs-6" style="border-right: 1px solid #000; font-size: 12px; height: 125px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9" style="padding: 0">
                                    <strong>
                                        <asp:Label ID="lblProjectName" runat="server"></asp:Label></strong>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9" style="padding: 0">
                                    <address style="min-height: 65px;" class="m-b-5">
                                        <strong>
                                            <asp:Label ID="lblSupName" runat="server"></asp:Label><br />
                                            <asp:Label ID="lblSupAddress" runat="server"></asp:Label><br />
                                            <asp:Label ID="lblSupAddress2" runat="server"></asp:Label><br />
                                ...
                                <div class="col-xs-9" style="padding: 0">
                                    <strong>
                                        <asp:Label ID="lblSupEmail" runat="server"></asp:Label></strong>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-3">
                                ...
                                <div class="col-xs-9" style="padding: 0">
                                    <strong>
                                        <asp:Label ID="lblTRN" runat="server"></asp:Label></strong>
                                </div>
                            </div>
                    ...
                    <%--    <div class="col-xs-4 text-center hidden" style="border-right: 1px solid #ececec">
                        ...
                        <div class="col-xs-3" style="border-right: 1px solid #000; padding: 0; font-size: 12px; height: 125px;">
                            ...
                            <p class="text-center m-b-0">Quote Ref:</p>
                            <p class="text-center m-b-0" style="border-bottom: 1px solid #000; min-height: 20px;">
                                <b>
                                    <asp:Label ID="lblQuoteRef" runat="server"></asp:Label></b>
                            </p>
                            <p class="text-center m-b-0" style="min-height: 20px;">Completion:</p>
                            <p class="text-center m-b-0" style="min-height: 20px;">
                                <b>
                                    <asp:Label ID="lblCompleteion" runat="server"></asp:Label></b>
                            </p>
                        ...
                        <div class="col-xs-3" style="padding-right: 10px; padding-left: 0; font-size: 12px; height: 125px;">
                            <div>
                               ...
                               <%-- <p class="m-b-0 p-l-5 hidden" style="border-bottom: 1px solid #000;">
                                    <strong>DO No: </strong>
                                ...
                                <p class="text-center">
                                    <asp:Literal ID="lblPaymentTerms" runat="server"></asp:Literal>
                                </p>
                            </div>
                        </div>
                    </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Entry.aspx.cs" Inherits="BisellsERP.Purchase.Print.VAT.E.Entry" %>
                ...
                <div class="col-md-12 cambria-font">
                    ...
                    <div class="clearfix cambria-font">
                        ...
                        <%--<div class="col-xs-5 text-center hidden">
                            <h2 class="text-primary m-t-0 m-b-20"><strong>Purchase Entry</strong></h2>
                    ...
                    <div class="row cambria-font" style="margin-top: 15px;">
                        ...
                        <div class="col-xs-4 text-center cambria-font" style="border-right: 1px solid #ececec">
                            <h2 class="text-primary m-t-0 m-b-20 cambria-font"><strong>Purchase Entry</strong></h2>

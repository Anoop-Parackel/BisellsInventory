<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Return.aspx.cs" Inherits="BisellsERP.Purchase.Print.VAT.E.Return" %>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-xs-5 text-center hidden cambria-font">
                            <h2 class="text-primary m-t-0 m-b-20"><strong>Debit Note</strong></h2>
                    ...
                    <hr class="m-0" />
                    <%-- INVOICE DETAILS --%>
                    <div class="row cambria-font" style="margin-top: 15px;">

                        <div class="col-xs-4 cambria-font" style="border-right: 1px solid #ececec">
                            <label class="control-label cambria-font">Details of Supplier</label>
                            <address class=" cambria-font" style="padding-left: 25px;">
                                <strong>
                        ...
                        <div class="col-xs-4 text-center cambria-font" style="border-right: 1px solid #ececec">
                            <h2 class="text-primary m-t-0 m-b-20 cambria-font"><strong>Debit Note</strong></h2>

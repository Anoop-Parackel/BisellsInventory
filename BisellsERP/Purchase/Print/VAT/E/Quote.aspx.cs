        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["id"] != null && Request.QueryString["location"] != null)
                {
                    ...
                    lblCurrency2.Text = Convert.ToString(settings.CurrencySymbol);
                    ...
                    lblSupplierAddress.Text = pq.BillingAddress[0].Address1;
                    ...
                    lblDueDate.Text = pq.DueDateString;
                    ...
                    lblSupTRN.Text = pq.SupplierTaxNo;
                    for (int i = 0; i < pq.Products.Count; i++)
                    {
                        TableRow r = new TableRow();
                        TableCell t1 = new TableCell();
                        t1.Text = pq.Products[i].ItemCode;
                        r.Cells.Add(t1);
                        ...
                        t10.Text = pq.Products[i].Gross.ToString();
                        r.Cells.Add(t10);

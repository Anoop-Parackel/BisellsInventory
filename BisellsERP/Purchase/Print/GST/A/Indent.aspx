<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Indent.aspx.cs" Inherits="BisellsERP.Purchase.Print.GST.A.Indent" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Purchase Indent Print</title>
      <%-- STYLE SHEETS --%>
                ...
                <div class="col-md-12">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-xs-5 text-center">
                            <h2 class="text-primary m-t-0 m-b-30"><strong>Purchase Indent</strong></h2>
                        ...
                        <div class="pull-right">
                            <address class="text-right">
                                <strong>
                                    <asp:Label ID="lblCompany" runat="server" /></strong><br />
                    ...
                    <div class="row">
                        <%--<div class="col-xs-4">
                            <label class="control-label">Issued From :</label>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRN.aspx.cs" Inherits="BisellsERP.Purchase.Print.GST.A.GRN" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-xs-5 text-center">
                            <h2 class="text-primary m-t-0 m-b-30"><strong>Goods Reciept Note</strong></h2>
                        ...
                        <div class="pull-right">
                            <address class="text-right">
                                ...
                                <asp:Label ID="lblCompState" runat="server" />,<asp:Label ID="lblCompCountry" runat="server" /><br />
                                <b>Ph : </b>
                    ...
                    <div class="row" style="margin-top: 15px;">
                        <div class="col-xs-4" style="border-right: 1px solid #ececec">
                            ...
                            <address style="padding-left: 25px;">
                                ...
                                <asp:Label ID="lblSupAddr1" runat="server" /><br />
                                <asp:Label ID="lblSupAddr2" runat="server" /><br />
                                <asp:Label ID="lblSupState" runat="server" /><br />
                                <asp:Label ID="lblSupCountry" runat="server" /><br />
                                <b>Ph :</b>
                                <asp:Label ID="lblSupPhone" runat="server" /><br />
                                <b>TaxNo : </b>
                                <asp:Label ID="lblSupTaxNo" runat="server" />
                            </address>
                        </div>
                        <div class="col-xs-4">
                            ...
                            <div class="table-responsive">
                                <asp:Table ID="listTable" CssClass="table m-t-30" runat="server">
                                    <asp:TableRow>
                                        ...
                                        <asp:TableHeaderCell>Recieved Quantity</asp:TableHeaderCell>
                                        <asp:TableHeaderCell>%</asp:TableHeaderCell>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Quote.aspx.cs" Inherits="BisellsERP.Purchase.Print.GST.A.Quote" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-xs-5 text-center">
                            <h2 class="text-primary m-t-0 m-b-30"><strong>Purchase Order </strong></h2>
                        ...
                        <div class="pull-right">
                            <address class="text-right">
                                ...
                                <b>RegistrationId :</b>
                                <asp:Label ID="lblComRegId" runat="server" />
                            </address>
                        </div>
                    </div>
                    <hr class="m-0" />
                    ...
                    <div class="row" style="margin-top: 15px;">
                        <div class="col-xs-4" style="border-right: 1px solid #ececec">
                            ...
                            <address style="padding-left: 25px;">
                                ...
                                <asp:Label ID="lblSupState" runat="server" />, <asp:Label ID="lblSupCountry" runat="server" /><br />
                                <b>Ph :</b>

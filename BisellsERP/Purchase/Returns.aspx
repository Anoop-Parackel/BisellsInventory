<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Returns.aspx.cs" Inherits="BisellsERP.Purchase.Returns" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="childContent" runat="server">
    ...
    <div class="row p-b-10">
        <div class="col-sm-4">
            <h3 class="page-title m-t-0">Debit Notes</h3>
        </div>
        <div class="col-sm-8">
                    ...
                    <div class="list-group-item active m-b-10">
                        <div class="btn-group">
                            <button type="button" class="trans-btn dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                All Debit Notes&nbsp;<b id="countOfInvoices">(0)</b>&nbsp;<span class="caret"></span>
                            </button>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="empty-state-wrap" style="display: none">
                                    ...
                                    <div class="btn-group empty-state-buttons">
                                        <a href="/Purchase/Return?MODE=new" class="btn btn-default btn-xs btn-rounded waves-effect">Create New Debit Note</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="">
                                    ...
                                    <div class="row" style="margin-top: 15px;">
                                        ...
                                        <div class="col-xs-4">
                                            <address>
                                                <b>
                                                    <small class="text-muted">Returned to&nbsp;</small><small id="lblSupName" class="underline"></small>
                                                </b>
                                                <br />
    ...
    <script>
        $(document).ready(function () {
            ...
            $.ajax({
                url: $('#hdApiUrl').val() + 'api/PurchaseReturn/GetCompanyDetails/',
                method: 'POST',
            ...
            $(document).on('click', '.left-side table tbody tr', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        //$('#lblSupCountry').text(data.SupCountry);
            ...
            $(document).on('click', '.edit-register', function () {
                window.open('/Purchase/Return?MODE=edit&UID=' + $('#hdRegisterId').val(), '_self');
            });
            ...
            $(document).on('click', '.print-register', function () {
                ...
                PopupCenter('/Purchase/print/' + type + '/' + number + '/Return?id=' + $('#hdRegisterId').val() + "&location=" + $.cookie('bsl_2'), 'purchaseReturn', 1000, 1000);
            });
            $(document).on('click', '.clone-register', function () {
                window.open('/Purchase/Return?MODE=clone&UID=' + $('#hdRegisterId').val(), '_self');
            });
            $(document).on('click', '.new-register', function () {
                window.open('/Purchase/Return?MODE=new', '_self');
            });

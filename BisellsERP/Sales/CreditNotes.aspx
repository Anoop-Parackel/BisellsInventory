<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreditNotes.aspx.cs" Inherits="BisellsERP.Sales.CreditNotes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="childContent" runat="server">
        ...
        <div class="left-sidebar">
            <div class="col-md-12">
                <div class="list-group m-b-0">
                    <div class="list-group-item active m-b-20">
                        <div class="btn-group">
                            ...
                            <div class="panel-body p-0" style="min-height: calc(100vh - 225px)">
                                ...
                                <div class="empty-state-wrap" style="display: none">
                                    ...
                                    <div class="btn-group empty-state-buttons">
                                        <a href="/Sales/CreditNote?MODE=new" class="btn btn-default btn-xs btn-rounded waves-effect">Create New CreditNote</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                url: $('#hdApiUrl').val() + 'api/CreditNote/GetCompanyDetails/',
                method: 'POST',
            ...
            $('#btnApproval').click(function () {
                ...
                $.ajax
                    ({
                        url: $('#hdApiUrl').val() + 'api/CreditNote/ToggleConfirm/' + id,
                        method: 'POST',
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'Json',
            ...
            $(document).on('click', '.print-register', function () {
                ...
                PopupCenter('/Sales/Prints/' + type + '/' + number + '/Return?id=' + $('#hdRegisterId').val() + '&location=' + $.cookie('bsl_2'), 'CreditNote', 800, 700);
            });

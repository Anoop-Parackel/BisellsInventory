<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Entry.aspx.cs" Inherits="BisellsERP.Sales.Prints.VAT.F.Entry" %>
...
<head runat="server">
    ...
    <style>
        ...
        @media print {
            ...
            #listTable tbody tr.footer.beige {
        ...
        <form id="form1" runat="server">
            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 text-right">
                        <address class="small-font">
                            ...
                            <asp:Label ID="lblCustomerAddress1" runat="server" />,
                            <asp:Label ID="lblCustomerAddress2" runat="server" /><br />
                            Ph :<asp:Label runat="server" id="lblCustPh"/><br />
                            <%-- Email Id Hidden --%>
                            <div class="hidden">E-mail :<asp:Label CssClass="text-primary" runat="server" id="lblCustEmail"/><br /></div> 
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <h5 class="text-right m-b-0"><strong>Date : <asp:Label CssClass="text-danger inv-detail-width" ID="lblDate" runat="server" ClientIDMode="Static"></asp:Label></strong></h5>
                        <h5 class="text-right m-t-0"><strong>Invoice No : <asp:Label CssClass="text-danger inv-detail-width" ID="lblInvoiceNo" runat="server" ClientIDMode="Static"></asp:Label></strong></h5>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h5 class="text-right m-t-0">In Words: <asp:Label ID="lblWords" runat="server" ClientIDMode="Static"></asp:Label></h5>
                    </div>
                </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryNote.aspx.cs" Inherits="BisellsERP.Sales.Prints.VAT.B.DeliveryNote" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-xs-5 text-center hidden">
                            <h2 class="text-primary m-t-0 m-b-20"><strong>Delivery Note</strong></h2>

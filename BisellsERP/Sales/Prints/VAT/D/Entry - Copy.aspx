<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Entry.aspx.cs" Inherits="BisellsERP.Sales.Prints.VAT.D.Entry" %>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-xs-6 text-right">
                            <h2 class="text-greeen m-t-40">
                                <strong><asp:Label ID="lblMainHead" runat="server" CssClass="underline text-green">Tax Invoice</asp:Label></strong>
                            </h2>
                            <br />
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6" style="border-right: 1px solid #000;font-size: 12px;height: 125px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9" style="padding:0">
                                    <address style="min-height: 65px;">
                                        <strong>
                                            <asp:Label ID="lblCustCare" runat="server" /></strong><br />
                                             C/O <asp:Label ID="lblCustName" runat="server"></asp:Label><br />
                        ...
                        <div class="col-xs-3" style="border-right: 1px solid #000; padding: 0;font-size: 12px; height: 125px;">
                            <p class="text-center m-b-0" style="min-height: 20px;">Invoice No: </p>
                            <p class="text-center m-b-0" style="border-bottom: 1px solid #000;min-height: 20px;"><b><asp:Label ID="lblInvoiceNo" Text="#xx" runat="server" /></b></p>
                            <p class="text-center m-b-0" style="min-height: 20px;">LPO No :</p>
                            <p class="text-center m-b-0" style="border-bottom: 1px solid #000;min-height: 20px;"><b><asp:Label ID="lblLPONumber" runat="server"></asp:Label></b></p>
                            <p class="text-center m-b-0" style="min-height: 20px;">Quote Ref:</p>
                            <p class="text-center m-b-0" style="min-height: 20px;"><b><asp:Label ID="lblQuoteRef" runat="server"></asp:Label></b></p>
                        ...
                        <div class="col-xs-3" style="padding-right: 10px;padding-left: 0;font-size: 12px;height: 125px;">
                            <div>
                                <p class="text-center m-b-0" style="min-height: 20px;">Date: </p>
                                <p class="text-center m-b-0" style="border-bottom: 1px solid #000;min-height: 20px;"><b><asp:Label ID="lblDate" Text="Jun 15, 2015" runat="server" /></b></p>
                                <p class="m-b-0 p-l-5" style="border-bottom: 1px solid #000;"><strong>DO No: </strong><asp:Label ID="lblDoNumber" runat="server"></asp:Label></p>
                                <p class="m-t-10 hidden">
                                    <strong>Registration Id : </strong>
                                    <asp:Label ID="lblCompGst" Text="#xx" runat="server" />
                                </p>
                                <p class="text-center m-b-0">Payment Terms: </p>
                                <p class="text-center"><b><asp:Label ID="lblPaymentTerms" runat="server"></asp:Label></b></p>
                            </div>
                        </div>
                    </div>
                    <%-- INVOICE ITEMS --%>
                    ...
                    <div class="row">
                        <div class="col-xs-9 text-center" style="padding-right: 0">
                            <p style="margin-top: 71px;margin-bottom: 0;padding-bottom: 2px;border-bottom: 1px solid #000;border-top: 1px solid #000;">
                        ...
                        <div class="col-xs-3" style="border-left: 1px solid black; font-size: 12px">
                            ...
                            <div class="row" style="border-bottom: 1px solid #000">
                                ...
                                <div class="col-xs-6 text-right">
                                    <strong><asp:Label ID="lblGross" Text="0.00" runat="server" /></strong>
                                </div>
                            </div>
                            ...
                            <div class="row" style="border-bottom: 1px solid #000">
                                ...
                                <div class="col-xs-6 text-right">
                                    <strong><asp:Label ID="lblTax" Text="0.00" runat="server" /></strong>
                                </div>
                            </div>
                            ...
                            <div class="row" style="border-bottom: 1px solid #000">
                                ...
                                <div class="col-xs-6 text-right">
                                    <strong><asp:Label ID="lblroundOff" Text="0.00" runat="server" /></strong>
                                </div>
                            </div>
                            ...
                            <div class="row" style="border-bottom: 1px solid #000">
                                ...
                                <div class="col-xs-6 text-right">
                                    <strong><asp:Label ID="lblDeduction" runat="server">0.00</asp:Label></strong>
                                </div>
                            </div>

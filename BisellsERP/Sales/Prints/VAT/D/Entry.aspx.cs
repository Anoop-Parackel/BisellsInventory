        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["id"] != null && Request.QueryString["location"] != null)
                {
                    ...
                    lblCustName.Text = sr.BillingAddress[0].ContactName;
                    lblComp.Text = sr.Company;
                    lblComTRN.Text = c.RegId1;
                    ...
                    lblCustMail.Text = sr.BillingAddress[0].Email;
                    lblCustAddress.Text = sr.BillingAddress[0].Address1;
                    lblCustAddress2.Text = sr.BillingAddress[0].Address2;
                    lblTRN.Text = sr.CustomerTaxNo;
                    lblCustCompany.Text = sr.Careof;
                    if (sr.PaymentStatus==0)
                    {
                        if (invoicetype=="delivery")
                        {
                            lblMainHead.Text = "DELIVERY NOTE";
                            thGross.Visible = false;
                            thNet.Visible = false;
                            thtax.Visible = false;

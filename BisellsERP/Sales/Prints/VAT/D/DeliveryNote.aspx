<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryNote.aspx.cs" Inherits="BisellsERP.Sales.Prints.VAT.D.DeliveryNote" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-xs-9 text-center">
                            <h2 class="text-primary m-t-0 m-b-20 pull-right"><strong>Delivery Note</strong></h2>
                            <p class="m-b-0 hidden">{ Original For Recipient }</p>
                        </div>
                    </div>
                    <hr class="m-0" />
                    <%-- INVOICE DETAILS --%>

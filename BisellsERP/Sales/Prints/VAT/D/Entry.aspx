        ...
        <form id="form1" runat="server">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-xs-6 text-right">
                            <h2 class="text-greeen m-t-40">
                                <strong>
                                    <asp:Label ID="lblMainHead" runat="server" CssClass="underline text-green">Sales Invoice</asp:Label></strong>
                            </h2>
                            <br />
                            <label>Company TRN : </label> <asp:Label runat="server" ID="lblComTRN" ClientIDMode="Static"></asp:Label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6" style="border-right: 1px solid #000; font-size: 12px; height: 145px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9" style="padding:0">
                                    <strong><asp:Label ID="lblCustMail" runat="server"></asp:Label></strong>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-3" style="border-right: 1px solid #000; padding: 0; font-size: 12px; height: 145px;">
                            ...
                            <p class="text-center m-b-0" style="border-bottom: 1px solid #000; min-height: 20px;">
                                <b>
                                    <asp:Label ID="lblLPONumber" runat="server"></asp:Label></b>
                            </p>
                            <p class="text-center m-b-0" style="min-height: 20px;">Quote Ref:</p>
                            <p class="text-center m-b-0" style="min-height: 20px;">
                                <b>
                                    <asp:Label ID="lblQuoteRef" runat="server"></asp:Label></b>
                            </p>
                        ...
                        <div class="col-xs-3" style="padding-right: 10px; padding-left: 0; font-size: 12px; height: 145px;">
                            <div>
                                ...
                                <p class="m-b-0 p-l-5" style="border-bottom: 1px solid #000;">
                                    <strong>DO No: </strong>
                            ...
                            <div class="table-responsive">
                                <asp:Table ID="listTable" CssClass="table table-bordered" runat="server">
                                    <asp:TableRow>
                                        ...
                                        <asp:TableHeaderCell ID="thQty">Qty</asp:TableHeaderCell>
                                        <%--<asp:TableHeaderCell>Mrp</asp:TableHeaderCell>--%>
                                        <asp:TableHeaderCell ID="thRate">Rate</asp:TableHeaderCell>
                                        <%--<asp:TableHeaderCell>VAT %</asp:TableHeaderCell>--%>
                                        <asp:TableHeaderCell ID="thGross">Gross</asp:TableHeaderCell>
                                        <asp:TableHeaderCell ID="thtax">Tax </asp:TableHeaderCell>
                                        <asp:TableHeaderCell ID="thNet">Net</asp:TableHeaderCell>
                                    </asp:TableRow>
                    ...
                    <%-- INVOICE SUMMARY --%>
                    <div class="row">
                        <div class="col-xs-9 text-center" id="dvAmount" runat="server" style="padding-right: 0">
                        ...
                        <div class="col-xs-3" id="dvTotal" runat="server" style="border-left: 1px solid black; font-size: 12px">
                            ...
                            <div class="row" id="dvTax" runat="server" style="border-bottom: 1px solid #000">
                                <div class="col-xs-6 text-right">
                                    <span>VAT 5% :</span>
                                </div>
                                <div class="col-xs-6 text-right">
                            ...
                            <div class="row" id="dvRoundOff" runat="server" style="border-bottom: 1px solid #000">
                                <div class="col-xs-6 text-right">
                                    <span>Round Off :</span>
                                </div>
                                <div class="col-xs-6 text-right">
                            ...
                            <div class="row" id="dvDeduction" runat="server" style="border-bottom: 1px solid #000">
                                <div class="col-xs-6 text-right">
                                    <span>Deduction :</span>
                                </div>
                                <div class="col-xs-6 text-right">
                            ...
                            <h4 class="text-right" id="dvSummary" runat="server" style="border-bottom: 1px solid #000; margin: 0 0 0 -10px;">

        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["id"] != null && Request.QueryString["location"] != null)
                {
                    ...
                    lblCompanyPhone1.Text = c.MobileNo1;
                    lblCompanyPhone2.Text = c.MobileNo2;
                    lblCompanyTaxNo1.Text = c.RegId1;
                    lblCompanyTaxNo2.Text = c.RegId2;
                    ...
                    lblNetTotal.Text = Convert.ToString(sr.NetAmount);
                    lblSalesID.Text = Convert.ToString(id);
                    lblSalesRep.Text = Convert.ToString(sr.Employee);
                    lblDespatch.Text = Convert.ToString(sr.Despatch);
                    lblCartons.Text = Convert.ToString(sr.Cartons);
                    lblFrieghtAmount.Text = Convert.ToString(sr.FreightAmount);
                    lblDivision.Text = Convert.ToString(sr.CostCenter);
                    //lblCustPh.Text = Convert.ToString(sr.BillingAddress);
                    lblCompanySign.Text = c.Name;
                    ...
                    lblPayment.Text = sr.Payment_Terms;
                    ...
                    else
                    {
                        ...
                        tf.CssClass = "inv-footer";
                        TaxAmountcell.CssClass = "inv-footer first";
                        SubTotal.CssClass = "inv-footer ";
                        TableCell EmptyCell1 = new TableCell();
                        EmptyCell1.ColumnSpan = 3;
                        TaxAmountcell.Cells.Add(EmptyCell1);
                        ...
                        tfc2.Text = Convert.ToString(sr.TaxAmount);
                        ...
                        EmptyCell2.ColumnSpan = 3;
                        SubTotal.Cells.Add(EmptyCell2);
                        ...
                        tfc4.Text = Convert.ToString(sr.Gross);

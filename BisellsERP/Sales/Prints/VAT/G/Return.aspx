<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Return.aspx.cs" Inherits="BisellsERP.Sales.Prints.VAT.G.Return" %>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <h4 class="text-right inv-type">
                            <asp:Label ID="lblMainHead" runat="server">Credit Note</asp:Label>
                        </h4>

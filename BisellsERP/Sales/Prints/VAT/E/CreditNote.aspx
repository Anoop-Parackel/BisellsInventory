<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreditNote.aspx.cs" Inherits="BisellsERP.Sales.Prints.VAT.E.CreditNote" %>
...
<body>
    ...
    <div class="page page-padd" data-size="A4" style="font-family: 'Times New Roman'">
        ...
        <div class="row">
            <div class="col-xs-8 invoice-block cambria-font" style="visibility: hidden">
                <p class=" text-center" style="color: #fff">ENTERPRISE ICT SOLUTIONS FOR YOUR BUSINESS</p>
                <p class="m-b-0 text-center" style="color: #fff"><small>We are devoted to making technology intergrate seamlessly with your business</small></p>
                <p class="m-b-0 text-center" style="color: #fff"><small>Call today and allow us to to be your complete IT solutions provider</small></p>
            </div>
        </div>
        ...
        <div class="row fs-16 cambria-font">
            <div class="col-xs-12 cambria-font">
                ...
                <p class="text-justify cambria-font">
                ...
                <p class="m-t-40 m-b-20 cambria-font">Yours Sincerely,</p>
                <div class="">
                    <strong>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Request.aspx.cs" Inherits="BisellsERP.Sales.Prints.VAT.E.Request" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Sales Request Print</title>
      <%-- STYLE SHEETS --%>
                ...
                <div class="col-md-12 cambria-font">
                    ...
                    <div class="clearfix cambria-font">
                        ...
                        <div class="col-xs-5 text-center hidden cambria-font">
                            <h2 class="text-primary m-t-0 m-b-20 cambria-font"><strong>Sales Request</strong></h2>
                 ...
                 <%-- INVOICE DETAILS --%>
                    <div class="row cambria-font" style="margin-top: 15px;">
                       <div class="col-xs-4 cambria-font" style="border-right: 1px solid #ececec">
                        ...
                        <div class="col-xs-4 hidden cambria-font">

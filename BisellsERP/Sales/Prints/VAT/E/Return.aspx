<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Return.aspx.cs" Inherits="BisellsERP.Sales.Prints.VAT.E.Return" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-xs-5 text-center hidden">
                            <h2 class="text-primary m-t-0 m-b-20"><strong>Credit Note</strong></h2>
                 ...
                 <%-- INVOICE DETAILS --%>
                    <div class="row" style="margin-top: 15px;">
                       <div class="col-xs-4 cambria-font" style="border-right: 1px solid #ececec">
                            <label class="control-label cambria-font">Details of Receiver (Billed To)</label>
                        ...
                        <div class="col-xs-4 text-center cambria-font" style="border-right: 1px solid #ececec">
                            <h2 class="text-primary m-t-0 m-b-20 cambria-font"><strong>Credit Note</strong></h2>
                        ...
                        <p><strong>Date: </strong>
                            ...
                            <p class="m-t-10 cambria-font"><strong>Invoice No: </strong>
                                <asp:Label ID="lblInvoiceNo" Text="#xx" runat="server" /></p>
                            <p class="m-t-10 cambria-font"><strong>VAT Registration: </strong>

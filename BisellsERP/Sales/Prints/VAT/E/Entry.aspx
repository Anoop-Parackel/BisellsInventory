...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Entry.aspx.cs" Inherits="BisellsERP.Sales.Prints.VAT.E.Entry" %>
                        ...
                        <div class="col-xs-8 p-l-10">
                            ...
                            <div class="col-xs-12 text-left m-t-min ">
                                <address class="cambria-font">
                                  ...
                                  <label>Address:</label>  <asp:Label ID="lblCompAddr1" runat="server" /><br />
                                ...
                                <asp:Label ID="lblCompEmail" CssClass="text-primary" runat="server" /><br />
                                 <label class="">TRN:</label>    
                                <asp:Label ID="lblTrn" CssClass="text-primary" runat="server" /><br />
                                </address>
                            </div>
                        
                        </div>
                        <div class="col-xs-4 text-right">
                            <h3 class=" m-t-40 m-b-0 cambria-font" style="color:#0e4679;"><strong><asp:Label ID="lblMainHead" runat="server"> Invoice</asp:Label></strong></h3>
                            <br />
                            <%--<p class="m-b-0 m-t-10 pull-right"><asp:Label ID="lblPaymentStatus" runat="server">Paid</asp:Label></p>--%>
                        </div>
                            <div class="col-xs-12 p-b-10">
                                <div class="col-xs-7">
                                    <div class="col-xs-4 cambria-font" style="padding-left: 0;">
                                        <article>
                                            <h4 class="bg-dark-blue cambria-font" style="color: white; background-color: #0e4679">BILL TO</h4>
                                            <strong>
                                                <asp:Label Text="Anu" id="lblCustomer" runat="server" /></strong>
                                            <br />
                                            <strong>
                                                <asp:Label Text="India" ID="lblCustomerAddress" runat="server" /></strong>
                                            <br/>
                                   <strong>
                                                <asp:Label Text="India" ID="lblCustomerTrn" runat="server" /></strong>
                                        </article>
                                    </div>
                                ...
                                <div class="col-xs-3 text-right cambria-font">
                                  ...
                                  <label>  <strong>INVOICE# </strong></label> <br />
                                 ...
                                 <div class="col-xs-2  table-bordered-address text-center  cambria-font">
                                  <label><strong>
                                   ...
                                   <hr class="m-0  hr-white"/>
                                    <strong>   <asp:Label ID="lblInvoiceNo" Text="#xx" runat="server" /></strong></><br />
                                        <hr class="m-0  hr-white"/>
                                    <strong>  <asp:Label ID="lblCustName" runat="server" /></strong></><br />
                                       <hr class="m-0  hr-white"/>
                                    <strong>  <asp:Label ID="lblDuedate" runat="server" /></strong></><br />
                            ...
                            <div class="table-responsive">
                                <asp:Table ID="listTable" CssClass="table table-bordered cambria-font" runat="server">
                                    <asp:TableRow>
                                        ...
                                        <asp:TableHeaderCell ID="thTotal">Total</asp:TableHeaderCell>
                                    </asp:TableRow>
                                </asp:Table>
                            </div>
                        </div>
                    ...
                    <div class="row m-t-15">
                        ...
                        <div class="col-xs-12">
                         ...
                         <small>If you have queries about this invoice,please contact:</small><br />
                            <label class="text-primary">Mob:</label> <asp:Label ID="lblCompanyPhone" runat="server" />
                        ...
                        <div class="col-xs-6 " >
                            ...
                            <h4 class="m-t-20">ACCOUNTS MANAGER</h4>
                            
                         
                        </div>
                        <div class="col-xs-6 text-center ">
                            <h4 class="padd-top">CUSTOMER SIGNATURE</h4>
                         
                        </div>
                        
                    </div>
                    <div class="row text-center bg-light-blue cambria-font" style="background-color:#0abff0">
                        <label class="text-center text-white cambria-font" style="color:white">www.netwaretech.com</label>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreditNote.aspx.cs" Inherits="BisellsERP.Sales.Prints.VAT.C.CreditNote" %>
                    ...
                    <div class="row" style="margin-top: 15px;">
                       <div class="col-xs-4" style="border-right: 1px solid #ececec">
                        ...
                        <div class="col-xs-4 text-center" style="border-right: 1px solid #ececec">
                            <h2 class="text-primary m-t-0 m-b-20"><strong>Credit Invoice</strong></h2>
                            <p class="m-b-0">{ Original For Recipient }</p>
                        ...
                        <p><strong>Date: </strong>
                            ...
                            <p class="m-t-10"><strong> Registration Id : </strong>

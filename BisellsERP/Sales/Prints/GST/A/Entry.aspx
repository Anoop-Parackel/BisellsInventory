<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Entry.aspx.cs" Inherits="BisellsERP.Sales.Prints.GST.A.Entry" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-xs-5 text-center">
                            <h2 class="text-primary m-t-0 m-b-30"><strong>Sales Invoice</strong></h2>
                    ...
                    <div class="row" style="margin-top: 15px;">
                        <div class="col-xs-4" style="border-right: 1px solid #ececec">
                            ...
                            <address style="padding-left: 25px;">
                                ...
                                <asp:Label ID="lblCustState" Text="xx" runat="server" />,<asp:Label ID="lblCustCountry" runat="server" /><br />
                                <b>Ph : </b>

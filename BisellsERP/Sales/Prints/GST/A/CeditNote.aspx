<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CeditNote.aspx.cs" Inherits="BisellsERP.Sales.Prints.GST.A.CeditNote" %>
...
<head runat="server">
     ...
     <title>Sales CreditNote Print</title>
    <%-- STYLE SHEETS --%>
                ...
                <div class="col-md-12">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-xs-5 text-center">
                            <h2 class="text-primary m-t-0 m-b-30"><strong>Credit Note</strong></h2>
                    ...
                    <div class="row" style="margin-top: 15px;">
                        <div class="col-xs-4" style="border-right: 1px solid #ececec">
                            ...
                            <address style="padding-left: 25px;">
                                ...
                                <asp:Label ID="lblCustAddr1" runat="server" /><br />
                                <asp:Label ID="lblCustAddr2" runat="server" /><br />
                                 <asp:Label ID="lblCustState" runat="server" />,<asp:Label ID="lblCustCountry" runat="server" /><br />
                                <b>Ph : </b>
                                <asp:Label ID="lblCustPhone" runat="server" /><br />
                                <b>TaxNo : </b>
                                <asp:Label ID="lblCustTaxNo" runat="server" />
                            </address>
                        </div>
                        <div class="col-xs-4">
                            <label class="control-label">Quoted From :</label>
                            <address style="padding-left: 25px;">
                                <strong>

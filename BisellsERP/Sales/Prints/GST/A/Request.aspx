<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Request.aspx.cs" Inherits="BisellsERP.Sales.Prints.GST.A.Request" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="clearfix">
                        ...
                        <div class="col-xs-5 text-center">
                            <h2 class="text-primary m-t-0 m-b-30"><strong>Sales Request</strong></h2>
                    ...
                    <div class="row" style="margin-top: 15px;">
                        ...
                        <div class="col-xs-4">
                            <label class="control-label">Requested From :</label>
                            <address style="padding-left: 25px;">
                                <strong>

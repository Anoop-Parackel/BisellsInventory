<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Designation.aspx.cs" Inherits="BisellsERP.Payroll.Designation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="childContent" runat="server">
        ...
        <asp:HiddenField ID="hdDesigId" ClientIDMode="Static" runat="server" Value="0" />
        <%--Page Title and Breadcrumb--%>
        <div class="row">
            <div class="col-sm-12">
                <h3 class="pull-left page-title">Designation</h3>
                ...
                <div class="portlet b-r-8">
                    <div class="portlet-heading portlet-default">
                        <h3 class="portlet-title">
                            <a id="btnAdd" data-toggle="collapse" data-parent="#accordion1" href="#add-item-portlet" class="text-primary"><i class="ion-ios7-plus-outline"></i>&nbsp Add New Designation </a>
                        </h3>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrapper">
                                            <asp:TextBox data-validation="required" MaxLength="35" data-validation-error-msg="<small style='color:red'>This field is required</small>"
                                                ID="txtDesignation" ClientIDMode="Static" runat="server" class="form-control " placeholder="Designation"></asp:TextBox>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrapper">
                                            <asp:DropDownList ClientIDMode="Static" CssClass="form-control" ID="ddlDept" runat="server"></asp:DropDownList>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    $(document).on('click', '.edit-entry', function () {
                        ...
                        $.ajax({
                            url: apirul + '/api/Designations/get/' + id,
                            method: 'POST',
                    ...
                    $(document).on('click', '.delete-entry', function () {
                        ...
                        deleteMaster({
                            "url": apirul + '/api/Designations/Delete/',
                            "id": id,
                    ...
                    function RefreshTable() {
                        $.ajax({
                            url: apirul + '/api/Designations/get/',
                            method: 'POST',
                            contentType: 'application/json; charset=utf-8',
                            dataType: 'Json',
                            data: JSON.stringify($.cookie("bsl_1")),

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Departments.aspx.cs" Inherits="BisellsERP.Payroll.Departments" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="childContent" runat="server">
    <div class="">
        ...
        <asp:HiddenField ID="hdDeptId" ClientIDMode="Static" runat="server" Value="0" />
        <%--Page Title and Breadcrumb--%>
        <div class="row">
            <div class="col-sm-12">
                <h3 class="pull-left page-title">Departments</h3>
                ...
                <div class="portlet b-r-8">
                    <div class="portlet-heading portlet-default">
                        <h3 class="portlet-title">
                            <a id="btnAdd" data-toggle="collapse" data-parent="#accordion1" href="#add-item-portlet" class="text-primary"><i class="ion-ios7-plus-outline"></i>&nbsp Add New Department </a>
                        </h3>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrapper ">
                                            <asp:TextBox data-validation="required" MaxLength="40" data-validation-error-msg="<small style='color:red'>This field is required</small>" ID="txtDept" ClientIDMode="Static" runat="server" class="form-control " placeholder="Name"></asp:TextBox>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $(document).on('click', '.edit-entry', function () {
                    ...
                    $.ajax({
                        url: apirul + '/api/Departments/get/' + id,
                        method: 'POST',
                        ...
                        success: function (response) {
                            reset();
                            $('#txtDept').val(response.Name);
                            $('#ddlStatus').val(response.Status);
                            $('#hdDeptId').val(response.ID);
                ...
                $(document).on('click', '.delete-entry', function () {
                    ...
                    deleteMaster({
                        "url": apirul + '/api/Departments/Delete/',
                        "id": id,
                ...
                function RefreshTable() {
                    $.ajax({
                        url: apirul + '/api/Departments/get/',
                        method: 'POST',
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'Json',
                        data: JSON.stringify($.cookie("bsl_1")),
